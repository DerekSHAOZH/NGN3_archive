...
ratio.path="/project/owlmayerTemporary/Bressin/Paper_Repository/Neurodifferentiation/Result/IsoformMS_SQANTI3_customProteome/ratio.atLeastTwoProteinIsoforms.integrative.tab"
...
out="/project/owlmayerTemporary/Bressin/Paper_Repository/Neurodifferentiation/Result/IsoformMS_SQANTI3_customProteome/trendChanges.integrative.pdf"
nCluster=4
RNA.path="/project/owlmayerTemporary/Bressin/Paper_Repository/Neurodifferentiation/Result/IsoformMS_SQANTI3_customProteome/RNA-seq.txt"
...
colnames(RNA)=c("Illumina_log2FC","transcript_id","Comparison")
...
RNA=RNA[,.(Illumina_Day1_vs_Day0_ratio=Illumina_log2FC[Comparison=="Day1_vs_Day0"],
       Illumina_Day2_vs_Day1_ratio=Illumina_log2FC[Comparison=="Day2_vs_Day1"],
       Illumina_Day3_vs_Day2_ratio=Illumina_log2FC[Comparison=="Day3_vs_Day2"],
       Illumina_Day5_vs_Day3_ratio=Illumina_log2FC[Comparison=="Day5_vs_Day3"])
,by="transcript_id"]
...
RATIO_FILTER=RATIO_FILTER[,.(Gene.IDs=unique(Gene.IDs),
                             ...
                             MS_Day1_vs_Day0=unique(Day1_vs_Day0_ratio),
                             MS_Day2_vs_Day1=unique(Day2_vs_Day1_ratio),
                             MS_Day3_vs_Day2=unique(Day3_vs_Day2_ratio),
                             MS_Day5_vs_Day3=unique(Day5_vs_Day3_ratio),
                             Illumina_Day1_vs_Day0=summarize(Illumina_Day1_vs_Day0_ratio, method=method),
                             Illumina_Day2_vs_Day1=summarize(Illumina_Day2_vs_Day1_ratio, method=method),
                             Illumina_Day3_vs_Day2=summarize(Illumina_Day3_vs_Day2_ratio, method=method),
                             Illumina_Day5_vs_Day3=summarize(Illumina_Day5_vs_Day3_ratio, method=method)
                             ),by=c("Protein.IDs")]

RATIO_FILTER_TIDY = RATIO_FILTER[,.(MS_log2FC=c(MS_Day1_vs_Day0,
                                                MS_Day2_vs_Day1,
                                                MS_Day3_vs_Day2,
                                                MS_Day5_vs_Day3),
                                    Illumina_log2FC=c(Illumina_Day1_vs_Day0,
                                                      Illumina_Day2_vs_Day1,
                                                      Illumina_Day3_vs_Day2,
                                                      Illumina_Day5_vs_Day3),
                                    Comparison=c("Day1_vs_Day0",
                                                 "Day2_vs_Day1",
                                                 "Day3_vs_Day2",
                                                 "Day5_vs_Day3")
                                    ),
...
for(gene in genes_of_interest){
  ...
  p2=ggplot(data=subset(RATIO_FILTER_TIDY, Gene.IDs==gene), 
            aes(x=Comparison, y=Illumina_log2FC, fill=Protein.IDs)) +
    stat_summary(
      fun = median,
      alpha=0.6,
      size=2,
...
TREND_DIFFERENCE=RATIO_FILTER[,.(MS_Day1_vs_Day0=absTrendDifference(MS_Day1_vs_Day0),
                                               MS_Day2_vs_Day1=absTrendDifference(MS_Day2_vs_Day1),
                                               MS_Day3_vs_Day2=absTrendDifference(MS_Day3_vs_Day2),
                                               MS_Day5_vs_Day3=absTrendDifference(MS_Day5_vs_Day3),
                                               Illumina_Day1_vs_Day0=absTrendDifference(Illumina_Day1_vs_Day0),
                                               Illumina_Day2_vs_Day1=absTrendDifference(Illumina_Day2_vs_Day1),
                                               Illumina_Day3_vs_Day2=absTrendDifference(Illumina_Day3_vs_Day2),
                                               Illumina_Day5_vs_Day3=absTrendDifference(Illumina_Day5_vs_Day3),
...
###############################################################################
TREND_DIFFERENCE_TIDY=TREND_DIFFERENCE[,.(MS_trend=c(MS_Day1_vs_Day0,
                                                     MS_Day2_vs_Day1,
                                                     MS_Day3_vs_Day2,
                                                     MS_Day5_vs_Day3),
                                          Illumina_trend=c(Illumina_Day1_vs_Day0,
                                                           Illumina_Day2_vs_Day1,
                                                           Illumina_Day3_vs_Day2,
                                                           Illumina_Day5_vs_Day3),
                                          Comparison=c("Day1_vs_Day0",
...
CORR=cor(as.data.frame(RATIO_FILTER)[,grepl("Day",colnames(RATIO_FILTER))], method = "pearson")[5:8,1:4]
