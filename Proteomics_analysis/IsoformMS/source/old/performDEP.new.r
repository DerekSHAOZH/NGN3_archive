...
annotation.path="/project/owlmayerTemporary/Bressin/Paper_Repository/Neurodifferentiation/Result/IsoformMS_SQANTI3_customProteome/annotation.info.txt"
comparisonL="Day1_vs_Day0;Day2_vs_Day1;Day3_vs_Day2;Day5_vs_Day3"
...
data <- subset(data, (is.na(Reverse) & is.na(Potential.contaminant)))
